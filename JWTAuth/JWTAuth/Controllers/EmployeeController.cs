...
namespace JWTAuth.Controllers
{
    ...
    public class EmployeeController : ControllerBase
    {
        ...
        {
            var employee = await Task.FromResult(_IEmployee.GetEmployeeDetails(id));
            if (employee == null)
            {
                return NotFound();
            }
        ...
        // PUT api/employee/5
        [HttpPut("{id}")]
        public async Task<ActionResult<Employee>> Pub(int id, Employee employee)
        {
